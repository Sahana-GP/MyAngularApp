...
@NgModule({
  declarations: [
    AppComponent, MyComponent, ImageDisplay,ForEachComponent, IfExampleComponent, CustomDirective, Product, PipeExampleComponent, SortPipe, MyServiceComponent, EmplyeeDetailsComponent, ProductsDetailsComponent, PostExampleComponent, MyFormComponent,  MyReactiveComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
